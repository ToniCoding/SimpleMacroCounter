 ...
 */
final class Version20260306153619 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE foods (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, protein INT NOT NULL, carbs INT NOT NULL, fats INT NOT NULL, fiber INT NOT NULL, market VARCHAR(255) NOT NULL, INDEX IDX_3803909DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
